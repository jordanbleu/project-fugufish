...
namespace Assets.Source.Components.Brain.Base
{
    public abstract class AIBehaviorBase : ComponentBase
    {
        ...
        //private float lookaheadDistanceNear = 0.25f;
        //protected float LookaheadDistanceNear { get => lookaheadDistanceNear; }

        //[SerializeField]
        //[Tooltip("How far ahead the actor can see far obstacles")]
        //private float lookaheadDistanceFar = 3;
        //protected float LookaheadDistanceFar { get => lookaheadDistanceFar; }
        ...
        //    var closeHit = Physics2D.Raycast(new Vector2(footCenter.x, footCenter.y- LOOK_BELOW_HEIGHT), new Vector2(direction, 0), lookaheadDistanceNear, walkableLayers, -999, 999);
        ...
        //        var farHit = Physics2D.Raycast(new Vector2(footCenter.x, footCenter.y - LOOK_BELOW_HEIGHT), new Vector2(direction, 0), lookaheadDistanceFar, walkableLayers, -999, 999);
        ...
        //            Gizmos.DrawLine(feetCenter, new Vector2(feetCenter.x - lookaheadDistanceNear, feetCenter.y- LOOK_BELOW_HEIGHT));
        //            Gizmos.color = UnityUtils.Color(200, 25, 100);
        //            Gizmos.DrawLine(feetCenter, new Vector2(feetCenter.x - lookaheadDistanceFar, feetCenter.y- LOOK_BELOW_HEIGHT));
        //        } else {
        //            Gizmos.color = UnityUtils.Color(200, 50, 200);
        //            Gizmos.DrawLine(feetCenter, new Vector2(feetCenter.x + lookaheadDistanceNear, feetCenter.y- LOOK_BELOW_HEIGHT));
        //            Gizmos.color = UnityUtils.Color(200, 25, 100);
